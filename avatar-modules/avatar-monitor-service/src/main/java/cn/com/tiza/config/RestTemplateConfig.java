 ...
 */
@Configuration
@EnableConfigurationProperties({HttpProperties.class, ApplicationProperties.class})
public class RestTemplateConfig {

    @Autowired
    private RestTemplateBuilder restTemplateBuilder;

    private ApplicationProperties.HttpPool pool;

    @Autowired
    public RestTemplateConfig(ApplicationProperties properties) {
