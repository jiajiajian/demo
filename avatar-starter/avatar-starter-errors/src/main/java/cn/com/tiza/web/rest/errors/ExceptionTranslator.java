...
import cn.com.tiza.errors.DefaultProblem;
import cn.com.tiza.errors.Problem;
import cn.com.tiza.errors.ProblemBuilder;
import cn.com.tiza.errors.Status;
import cn.com.tiza.errors.advice.*;
import cn.com.tiza.errors.violation.ConstraintViolationProblem;
import cn.com.tiza.web.rest.util.HeaderUtil;
...
public class ExceptionTranslator implements
    ...
    public ResponseEntity<Problem> handleBadRequestException(BadRequestException ex, NativeWebRequest request) {
        return create(ex, request, HeaderUtil.createFailureAppHeader( ex.getErrorCode(), ex.getErrFileUrl()));
    }
