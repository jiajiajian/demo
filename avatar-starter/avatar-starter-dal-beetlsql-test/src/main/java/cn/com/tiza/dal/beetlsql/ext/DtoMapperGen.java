...
public class DtoMapperGen {
    /**
     * logger
     */
    public static String defaultPkg = "cn.com.tiza.service.mapper";
    ...
    private final static String defaultTemplatePath = "/cn/com/tiza/dal/beetlsql/ext/mapper.btl";
    /**
    ...
    public DtoMapperGen(SQLManager sm, String table, String pkg, String srcPath, GenConfig config){
    ...
    public static  void saveSourceFile(String srcPath,String pkg,String className,String content) throws IOException{
        ...
        File target = new File(file,className+"Mapper.java");
