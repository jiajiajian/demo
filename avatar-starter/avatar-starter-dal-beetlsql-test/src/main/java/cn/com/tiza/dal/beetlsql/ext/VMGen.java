...
public class VMGen {
     ...
     * logger
     */
    public static String defaultPkg = "cn.com.tiza.web.rest.vm";
    ...
    private final static String defaultTemplatePath = "/cn/com/tiza/dal/beetlsql/ext/vm.btl";
    /**
    ...
    public VMGen(SQLManager sm, String table, String pkg, String srcPath, GenConfig config){
    ...
    public static  void saveSourceFile(String srcPath,String pkg,String className,String content) throws IOException{
        ...
        File target = new File(file,className+"VM.java");
