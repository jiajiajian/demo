...
public class QueryGen {
    ...
    private static final String suffix = "Query";
    ...
    private final static String defaultTemplatePath = "/cn/com/tiza/dal/beetlsql/ext/query.btl";
    /**
    ...
    public QueryGen(SQLManager sm, String table, String pkg, String srcPath, GenConfig config){
