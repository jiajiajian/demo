/*******************************************************************************
 * Copyright (c) 2016-2019 天泽信息 www.tiza.com.cn
 *
 *******************************************************************************/
...
public class Servlets {
    ...
    public static void setFileDownloadHeader(HttpServletRequest request, HttpServletResponse response, String fileName) {
        ...
        if (isMSIE) {
            encodedfileName = EncodeUtil.urlEncode(encodedfileName);
        } else {
    ...
    public static Map<String, Object> getParametersStartingWith(ServletRequest request, String prefix) {
        ...
        boolean prefixIsEmpty = false;
        if (prefix == null) {
            prefix = "";
        }
        prefixIsEmpty = "".equals(prefix);
        while ((paramNames != null) && paramNames.hasMoreElements()) {
            String paramName = (String) paramNames.nextElement();
            if (prefixIsEmpty || paramName.startsWith(prefix)) {
     ...
     * @param likeFields
     */
    public static void wrapLikeFields(Map<String, Object> searchParams, Set<String> likeFields, boolean isLeft) {
        for(String key : searchParams.keySet()) {
            if(likeFields.contains(key)) {
                String val = (String) searchParams.get(key);
     ...
     * @param likeFields
     */
    public static void wrapLikeFields(Map<String, Object> searchParams, Set<String> likeFields) {
        if(! likeFields.isEmpty()) {
            for(String key : likeFields) {
                String val = (String) searchParams.get(key);
                if(StringUtils.hasText(val)) {
                    searchParams.put(key, "%" + val + "%");
                }
